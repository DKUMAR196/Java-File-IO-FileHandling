...
public class AddressBook {
    ...
    public void writeDataInAFile() {
    	try {
			FileWriter fileWriter = new FileWriter("C:\\Users\\deepa\\eclipse-workspace\\Day27_Address_Book_FileHandling\\src\\com\\bridgelabz\\file\\addressBook.txt");
			BufferedWriter bf =  new BufferedWriter(fileWriter);
			for(Person element : list ) {
				bf.write(element + System.lineSeparator());
    ...
    private void readAddressBook() {
        try {
            BufferedReader bufferedReader = new BufferedReader(new FileReader("C:\\Users\\deepa\\eclipse-workspace\\Day27_Address_Book_FileHandling\\src\\com\\bridgelabz\\file\\addressBook.txt"));
            String line = " ";
            while (line != null){
